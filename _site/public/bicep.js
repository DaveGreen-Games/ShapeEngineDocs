...
export function bicep(hljs) {
  ...
  var after = function (regex) {
    return "(?<=" + regex + ")";
  };
  var notAfter = function (regex) {
    return "(?<!" + regex + ")";
  };
  var before = function (regex) {
    return "(?=" + regex + ")";
  };
  var notBefore = function (regex) {
    return "(?!" + regex + ")";
  };
  ...
  var KEYWORDS = {
    ...
    literal: ["true", "false", "null"].join(" "),
    built_in: ["az", "sys"].join(" "),
  };
  var lineComment = {
    className: "comment",
    begin: "//",
